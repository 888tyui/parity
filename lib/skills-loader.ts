...
> = {
    "security-audit": {
        ...
        installCommand: "curl -s https://parity.cx/api/skills/security-audit | sh",
    ...
    "best-practices": {
        ...
        tags: ["tooling", "anchor"],
        installCommand: "curl -s https://parity.cx/api/skills/best-practices | sh",
    ...
    "gas-optimization": {
        ...
        compatibility: ["Cursor", "Claude Code", "Windsurf"],
        tags: ["tooling", "anchor"],
        installCommand: "curl -s https://parity.cx/api/skills/gas-optimization | sh",
    ...
    "deep-audit": {
        ...
        installCommand: "curl -s https://parity.cx/api/skills/deep-audit | sh",
    ...
    "cpi-validator": {
        ...
        installCommand: "curl -s https://parity.cx/api/skills/cpi-validator | sh",
        lastUpdated: "2026-02-13",
    },
    "defi-review": {
        ...
        compatibility: ["Cursor", "Claude Code"],
        tags: ["defi", "security"],
        installCommand: "curl -s https://parity.cx/api/skills/defi-review | sh",
    ...
    "idl-docs": {
        ...
        compatibility: ["Cursor", "Claude Code", "Windsurf", "Copilot"],
        tags: ["tooling", "anchor"],
        installCommand: "curl -s https://parity.cx/api/skills/idl-docs | sh",
        lastUpdated: "2026-02-11",
    },
    "pda-helper": {
        ...
        compatibility: ["Cursor", "Claude Code", "Windsurf"],
        tags: ["anchor", "tooling"],
        installCommand: "curl -s https://parity.cx/api/skills/pda-helper | sh",
    ...
    "test-generator": {
        ...
        installCommand: "curl -s https://parity.cx/api/skills/test-generator | sh",
        lastUpdated: "2026-02-12",
    },
    "token-analyzer": {
        ...
        compatibility: ["Cursor", "Claude Code"],
        tags: ["token", "security"],
        installCommand: "curl -s https://parity.cx/api/skills/token-analyzer | sh",
    ...
    "account-lifecycle": {
        ...
        installCommand: "curl -s https://parity.cx/api/skills/account-lifecycle | sh",
        lastUpdated: "2026-02-09",
    },
};
